...
describe('App', function() {
	...
	// 	this.app.addRoutes(new Route('/xyz', CacheScreen));
	// 	this.app.navigate('/path1').then(() => {
	// 		var screenFirstNavigate = this.app.screens['/path1'];
	// 		this.app.navigate('/xyz').then(() => {
	// 			this.app.navigate('/path1').then(() => {
	...
	// 	var screen2 = this.app.createScreenInstance('/xyz', new Route('/xyz', HtmlScreen));
	// 	this.app.activePath = '/path1';
	// 	this.app.activeScreen = screen1;
	// 	this.app.screens['/path1'] = screen1;
	// 	this.app.screens['/xyz'] = screen2;
	// 	this.app.dispose();
	// 	assert.strictEqual(0, Object.keys(this.app.screens).length);
	// });
	...
	// 	this.app = new App();
	// 	this.app.addRoutes(new Route('/path1', Screen));
	// 	this.app.addRoutes(new Route('/xyz', Screen));
	// 	this.app.navigate('/path1')
	// 		.then(() => this.app.navigate('/xyz'))
	// 		.then(() => {
	// 			var activeScreen = this.app.activeScreen;
	// 			assert.strictEqual('/xyz', globals.window.location.pathname);
	...
	// 			var pendingNavigate2 = this.app.navigate('/xyz');
	// 			assert.ok(pendingNavigate1);
	// 			assert.ok(pendingNavigate2);
	...
	// 			assert.ok(payload.error instanceof Error);
	// 		});
	// 		this.app.navigate('/xyz').catch((reason) => {
	// 			assert.ok(reason instanceof Error);
	// 			done();
	// 		});
	// 	});
	...
	// 			assert.strictEqual('/xyz', this.app.activePath);
	// 			assert.strictEqual(1, beforeunload.callCount);
	// 			done();
	// 		});
	// 	});
	...
	// 	this.app.addRoutes(new Route('/xyz', StubScreen2));
	// 	this.app.navigate('/path1').then(() => {
	// 		this.app.navigate('/xyz').then(() => {
	// 			var lifecycleOrder = [
	...
	// 	this.app.addRoutes(new Route('/xyz', ContentScreen2));
	...
	// 			dom.triggerEvent(enterDocumentLinkElement('/xyz'), 'click');
	// 			exitDocumentLinkElement();
	...
	// 	this.app.addRoutes(new Route('/xyz', TestScreen2));
	...
	// 				assert.ok(this.app.screens['/xyz']);
	// 			});
	// 			this.app.once('endNavigate', () => {
