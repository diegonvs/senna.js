define("senna", ["path","url"], function(__WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_34__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var _Disposable = __webpack_require__(26);
...
var Uri = __webpack_require__(22).default;
...
var _globals = _interopRequireDefault(__webpack_require__(1));

var _metalUri = _interopRequireDefault(__webpack_require__(4));
...
function () {
  ...
  _createClass(utils, null, [{
    ...
    value: function getCurrentBrowserPath() {
      return this.getCurrentBrowserPathWithoutHash() + _globals.default.window.location.hash;
    }
    /**
    ...
    value: function getCurrentBrowserPathWithoutHash() {
      return _globals.default.window.location.pathname + _globals.default.window.location.search;
    }
    /**
    ...
    value: function getUrlPath(url) {
      var uri = new _metalUri.default(url);
    ...
    value: function isHtml5HistorySupported() {
      return !!(_globals.default.window.history && _globals.default.window.history.pushState);
    }
    /**
    ...
    value: function isWebUri(url) {
      try {
        return new _metalUri.default(url);
      } catch (err) {
...
var _DomEventHandle = __webpack_require__(15);
...
var _metalPathParser = __webpack_require__(48);
...
var _Cacheable2 = _interopRequireDefault(__webpack_require__(49));

var _metalPromise = _interopRequireDefault(__webpack_require__(3));
...
function (_Cacheable) {
  ...
  _createClass(Screen, [{
    ...
    value: function evaluateScripts(surfaces) {
      ...
      return _metalPromise.default.resolve();
    }
    /**
    ...
    value: function flip(surfaces) {
      ...
      return _metalPromise.default.all(transitions);
    }
    /**
     * Gets the screen id.
     * @return {string}
...
var _coreNamed = __webpack_require__(23);
...
var _MultiMap = __webpack_require__(31);

var _MultiMap2 = _interopRequireDefault(_MultiMap);

var _TreeNode = __webpack_require__(32);
...
var _metalDebounce = _interopRequireDefault(__webpack_require__(47));

var _globals = _interopRequireDefault(__webpack_require__(1));

var _Route = _interopRequireDefault(__webpack_require__(9));

var _Screen = _interopRequireDefault(__webpack_require__(10));

var _Surface = _interopRequireDefault(__webpack_require__(17));
...
function (_EventEmitter) {
  ...
  function App() {
    ...
    _this.browserPathBeforeNavigate = _utils.default.getCurrentBrowserPathWithoutHash();
    /**
    ...
    _this.defaultTitle = _globals.default.document.title;
    /**
    ...
    _this.nativeScrollRestorationSupported = 'scrollRestoration' in _globals.default.window.history;
    /**
    ...
    _this.appEventHandlers_.add((0, _metalDom.on)(_globals.default.window, 'scroll', (0, _metalDebounce.default)(_this.onScroll_.bind(_this), 100)), (0, _metalDom.on)(_globals.default.window, 'load', _this.onLoad_.bind(_this)), (0, _metalDom.on)(_globals.default.window, 'popstate', _this.onPopstate_.bind(_this)));
  ...
  _createClass(App, [{
    ...
    value: function addRoutes(routes) {
      ...
      routes.forEach(function (route) {
        if (!(route instanceof _Route.default)) {
          route = new _Route.default(route.path, route.handler);
        }
    ...
    value: function addSurfaces(surfaces) {
      ...
      surfaces.forEach(function (surface) {
        if ((0, _metal.isString)(surface)) {
          surface = new _Surface.default(surface);
        }
    ...
    value: function canNavigate(url) {
      var uri = _utils.default.isWebUri(url);

      if (!uri) {
        return false;
      }

      var path = _utils.default.getUrlPath(url);
      ...
      if (uri.getHash() && _utils.default.isCurrentBrowserPath(path)) {
        return false;
      }
    ...
    value: function createScreenInstance(path, route) {
      ...
      if (!screen) {
        ...
        if (handler === _Screen.default || _Screen.default.isImplementedBy(handler.prototype)) {
          screen = new handler();
        } else {
          screen = handler(route) || new _Screen.default();
        }
    ...
    value: function dispatch() {
      return this.navigate(_utils.default.getCurrentBrowserPath(), true);
    }
    /**
    ...
    value: function doNavigate_(path, opt_replaceHistory) {
      ...
      if (this.activeScreen && this.activeScreen.beforeDeactivate()) {
        this.pendingNavigate = _metalPromise.default.reject(new _metalPromise.default.CancellationError('Cancelled by active screen'));
      ...
      if (!route) {
        this.pendingNavigate = _metalPromise.default.reject(new _metalPromise.default.CancellationError('No route for ' + path));
        return this.pendingNavigate;
      }
    ...
    value: function finalizeNavigate_(path, nextScreen) {
      ...
      this.browserPathBeforeNavigate = _utils.default.getCurrentBrowserPathWithoutHash();
      this.screens[path] = nextScreen;
      this.isNavigationPending = false;
      this.pendingNavigate = null;
      _globals.default.capturedFormElement = null;
      _globals.default.capturedFormButtonElement = null;
    ...
    value: function getRoutePath(path) {
      if (this.getIgnoreQueryStringFromRoutePath()) {
        path = _utils.default.getUrlPathWithoutHashAndSearch(path);
        return _utils.default.getUrlPathWithoutHashAndSearch(path.substr(this.basePath.length));
      }

      path = _utils.default.getUrlPathWithoutHash(path);
      return _utils.default.getUrlPathWithoutHash(path.substr(this.basePath.length));
    }
    /**
    ...
    value: function handleNavigateError_(path, nextScreen, error) {
      ...
      if (!_utils.default.isCurrentBrowserPath(path)) {
    ...
    value: function isLinkSameOrigin_(hostname) {
      return hostname === _globals.default.window.location.hostname;
    }
    /**
    ...
    value: function lockHistoryScrollPosition_() {
      var state = _globals.default.window.history.state;
      ...
      var switchScrollPositionRace = function switchScrollPositionRace() {
        _globals.default.document.removeEventListener('scroll', switchScrollPositionRace, false);

        if (!winner) {
          _globals.default.window.scrollTo(state.scrollLeft, state.scrollTop);
      ...
      _globals.default.document.addEventListener('scroll', switchScrollPositionRace, false);
    }
    /**
    ...
    value: function maybeDisableNativeScrollRestoration() {
      if (this.nativeScrollRestorationSupported) {
        this.nativeScrollRestoration_ = _globals.default.window.history.scrollRestoration;
        _globals.default.window.history.scrollRestoration = 'manual';
      }
    }
    /**
    ...
    value: function maybeNavigate_(href, event) {
      ...
      _globals.default.capturedFormElement = event.capturedFormElement;
      _globals.default.capturedFormButtonElement = event.capturedFormButtonElement;
      var navigateFailed = false;

      try {
        this.navigate(_utils.default.getUrlPath(href), false, event);
      } catch (err) {
    ...
    value: function maybeRepositionScrollToHashedAnchor() {
      var hash = _globals.default.window.location.hash;

      if (hash) {
        var anchorElement = _globals.default.document.getElementById(hash.substring(1));

        if (anchorElement) {
          var _utils$getNodeOffset = _utils.default.getNodeOffset(anchorElement),
              offsetLeft = _utils$getNodeOffset.offsetLeft,
              offsetTop = _utils$getNodeOffset.offsetTop;

          _globals.default.window.scrollTo(offsetLeft, offsetTop);
        }
      }
    }
    /**
    ...
    value: function maybeRestoreNativeScrollRestoration() {
      if (this.nativeScrollRestorationSupported && this.nativeScrollRestoration_) {
        _globals.default.window.history.scrollRestoration = this.nativeScrollRestoration_;
      }
    }
    /**
    ...
    value: function maybeRestoreRedirectPathHash_(path, redirectPath, hash) {
      if (redirectPath === _utils.default.getUrlPathWithoutHash(path)) {
    ...
    value: function maybeUpdateScrollPositionState_() {
      ...
      if (anchorElement) {
        var _utils$getNodeOffset2 = _utils.default.getNodeOffset(anchorElement),
    ...
    value: function navigate(path, opt_replaceHistory, opt_event) {
      if (!_utils.default.isHtml5HistorySupported()) {
    ...
    value: function onBeforeNavigate_(event) {
      if (_globals.default.capturedFormElement) {
        event.form = _globals.default.capturedFormElement;
      }
    }
    /**
    ...
    value: function onDocSubmitDelegate_(event) {
      ...
      if ((0, _metalDom.match)(_globals.default.document.activeElement, buttonSelector)) {
        event.capturedFormButtonElement = _globals.default.document.activeElement;
      } else {
    ...
    value: function onPopstate_(event) {
      ...
      if (_utils.default.isCurrentBrowserPath(this.browserPathBeforeNavigate)) {
        this.maybeRepositionScrollToHashedAnchor();
        return;
      }
      ...
      if (!state) {
        if (_globals.default.window.location.hash) {
          // If senna is on an redirect path and a hash popstate happens
          // to a different url, reload the browser. This behavior doesn't
          // require senna to route hashed links and is closer to native
          // browser behavior.
          if (this.redirectPath && !_utils.default.isCurrentBrowserPath(this.redirectPath)) {
            this.reloadPage();
    ...
    value: function onScroll_() {
      if (this.captureScrollPositionFromScrollEvent) {
        this.saveHistoryCurrentPageScrollPosition_(_globals.default.window.pageYOffset, _globals.default.window.pageXOffset);
      }
    }
    /**
     * Starts navigation to a path.
    ...
    value: function onStartNavigate_(event) {
      ...
      (0, _metalDom.addClasses)(_globals.default.document.documentElement, this.loadingCssClass);
      ...
      this.pendingNavigate = this.doNavigate_(event.path, event.replaceHistory).catch(function (reason) {
        ...
        if (!_this9.pendingNavigate) {
          (0, _metalDom.removeClasses)(_globals.default.document.documentElement, _this9.loadingCssClass);
    ...
    value: function prefetch(path) {
      ...
      if (!route) {
        return _metalPromise.default.reject(new _metalPromise.default.CancellationError('No route for ' + path));
      }
    ...
    value: function prepareNavigateHistory_(path, nextScreen, opt_replaceHistory) {
      ...
      var historyState = {
        form: (0, _metal.isDefAndNotNull)(_globals.default.capturedFormElement),
        path: path,
      ...
      var hash = new _metalUri.default(path).getHash();
    ...
    value: function reloadPage() {
      _globals.default.window.location.reload();
    }
    /**
    ...
    value: function saveHistoryCurrentPageScrollPosition_(scrollTop, scrollLeft) {
      ...
      if (state && state.senna) {
        ...
        _globals.default.window.history.replaceState(state, null, null);
      }
    }
    /**
    ...
    value: function setBasePath(basePath) {
      this.basePath = _utils.default.removePathTrailingSlash(basePath);
    }
    /**
    ...
    value: function syncScrollPositionSyncThenAsync_() {
      ...
      var sync = function sync() {
        if (_this12.updateScrollPosition) {
          _globals.default.window.scrollTo(scrollLeft, scrollTop);
        }
      };

      return new _metalPromise.default(function (resolve) {
    ...
    value: function updateHistory_(title, path, state, opt_replaceHistory) {
      if (opt_replaceHistory) {
        _globals.default.window.history.replaceState(state, title, path);
      } else {
        _globals.default.window.history.pushState(state, title, path);
      }

      var titleNode = _globals.default.document.querySelector('title');

      if (titleNode) {
        titleNode.innerHTML = title;
      } else {
        _globals.default.document.title = title;
      }
    }
  }]);
...
function (_Disposable) {
  ...
  _createClass(Surface, [{
    ...
    value: function createChild(screenId) {
      var child = _globals.default.document.createElement('div');
    ...
    value: function getChild(screenId) {
      return _globals.default.document.getElementById(this.makeId_(screenId));
    }
    /**
    ...
    value: function getElement() {
      ...
      this.element = _globals.default.document.getElementById(this.id);
      return this.element;
    }
    /**
     * Gets the surface id.
    ...
    value: function maybeWrapContentAsDefault_() {
      ...
      if (element && !this.defaultChild) {
        var fragment = _globals.default.document.createDocumentFragment();
    ...
    value: function transition(from, to) {
      ...
      return _metalPromise.default.resolve(transitionFn.call(this, from, to));
    }
  }]);
...
var _RequestScreen2 = _interopRequireDefault(__webpack_require__(19));

var _Surface = _interopRequireDefault(__webpack_require__(17));

var _metalUseragent = _interopRequireDefault(__webpack_require__(20));
  ...
  _createClass(HtmlScreen, [{
    ...
    value: function allocateVirtualDocumentForContent(htmlString) {
      if (!this.virtualDocument) {
        this.virtualDocument = _globals.default.document.createElement('html');
      }
    ...
    value: function appendStyleIntoDocument_(newStyle) {
      ...
      if (newStyle.id) {
        var styleInDoc = _globals.default.document.getElementById(newStyle.id);
      ...
      _globals.default.document.head.appendChild(newStyle);
    }
    /**
    ...
    value: function assertSameBodyIdInVirtualDocument() {
      ...
      if (!_globals.default.document.body.id) {
        _globals.default.document.body.id = 'senna_surface_' + (0, _metal.getUid)();
      }

      if (bodySurface) {
        bodySurface.id = _globals.default.document.body.id;
      }
    }
    /**
    ...
    value: function copyNodeAttributesFromContent_(content, node) {
      ...
      if (placeholder) {
        _utils.default.clearNodeAttributes(node);

        _utils.default.copyNodeAttributes(placeholder, node);
      }
    }
    /**
     * @Override
    ...
    value: function flip(surfaces) {
      ...
      return _get(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), "flip", this).call(this, surfaces).then(function () {
        _utils.default.clearNodeAttributes(document.documentElement);

        _utils.default.copyNodeAttributes(_this5.virtualDocument, document.documentElement);
      });
    }
    /**
    ...
    value: function getSurfaceContent(surfaceId) {
      ...
      if (surface) {
        var defaultChild = surface.querySelector('#' + surfaceId + '-' + _Surface.default.DEFAULT);
    ...
    value: function load(path) {
      ...
      return _get(HtmlScreen.prototype.__proto__ || Object.getPrototypeOf(HtmlScreen.prototype), "load", this).call(this, path).then(function (content) {
        ...
        if (_metalUseragent.default.isIe) {
    ...
    value: function replaceStyleAndMakeUnique_(style) {
      if (style.href) {
        var newStyle = _globals.default.document.createElement(style.tagName);

        style.href = new _metalUri.default(style.href).makeUnique().toString();

        _utils.default.copyNodeAttributes(style, newStyle);
    ...
    value: function querySelectorAll_(selector) {
      return Array.prototype.slice.call(_globals.default.document.querySelectorAll(selector));
    }
    /**
...
var _metalAjax = _interopRequireDefault(__webpack_require__(50));

var _metalStructs = __webpack_require__(12);

var _metalPromise = _interopRequireDefault(__webpack_require__(3));

var _errors = _interopRequireDefault(__webpack_require__(51));

var _utils = _interopRequireDefault(__webpack_require__(5));

var _globals = _interopRequireDefault(__webpack_require__(1));

var _Screen2 = _interopRequireDefault(__webpack_require__(10));
  ...
  _createClass(RequestScreen, [{
    ...
    value: function assertValidResponseStatusCode(status) {
      if (!this.isValidResponseStatusCode(status)) {
        var error = new Error(_errors.default.INVALID_STATUS);
    ...
    value: function formatLoadPath(path) {
      var uri = new _metalUri.default(path);
      uri.setHostname(_globals.default.window.location.hostname);
      uri.setProtocol(_globals.default.window.location.protocol);

      if (_globals.default.window.location.port) {
        uri.setPort(_globals.default.window.location.port);
      }

      if (_metalUseragent.default.isIeOrEdge && this.httpMethod === RequestScreen.GET) {
    ...
    value: function getRequestPath() {
      ...
      if (request) {
        ...
        if (_metalUseragent.default.isIeOrEdge && this.httpMethod === RequestScreen.GET) {
          requestPath = new _metalUri.default(requestPath).removeUnique().toString();
        }

        return _utils.default.getUrlPath(requestPath);
      }
    ...
    value: function load(path) {
      ...
      if ((0, _metal.isDefAndNotNull)(cache)) {
        return _metalPromise.default.resolve(cache);
      }
      ...
      if (_globals.default.capturedFormElement) {
        body = new FormData(_globals.default.capturedFormElement);
        this.maybeAppendSubmitButtonValue_(body);
        httpMethod = RequestScreen.POST;

        if (_metalUseragent.default.isIeOrEdge) {
          headers.add('If-None-Match', '"0"');
        }
      }

      var requestPath = this.formatLoadPath(path);
      return _metalAjax.default.request(requestPath, httpMethod, body, headers, null, this.timeout).then(function (xhr) {
        ...
        switch (reason.message) {
          case _errors.default.REQUEST_TIMEOUT:
            reason.timeout = true;
            break;

          case _errors.default.REQUEST_ERROR:
            reason.requestError = true;
            break;

          case _errors.default.REQUEST_PREMATURE_TERMINATION:
            reason.requestError = true;
    ...
    value: function maybeAppendSubmitButtonValue_(body) {
      var button = _globals.default.capturedFormButtonElement;
...
Object.defineProperty(exports, "dataAttributeHandler", {
  enumerable: true,
  get: function get() {
    return _dataAttributeHandler.default;
  }
});
...
Object.defineProperty(exports, "HtmlScreen", {
  enumerable: true,
  get: function get() {
    return _HtmlScreen.default;
  }
});
Object.defineProperty(exports, "RequestScreen", {
  enumerable: true,
  get: function get() {
    return _RequestScreen.default;
  }
});
...
var _dataAttributeHandler = _interopRequireDefault(__webpack_require__(35));

var _App = _interopRequireDefault(__webpack_require__(13));

var _HtmlScreen = _interopRequireDefault(__webpack_require__(18));

var _RequestScreen = _interopRequireDefault(__webpack_require__(19));
...
var _parseFromAnchor = __webpack_require__(30);
...
var _AppDataAttributeHandler = _interopRequireDefault(__webpack_require__(36));
 ...
 */
var dataAttributeHandler = new _AppDataAttributeHandler.default();

_globals.default.document.addEventListener('DOMContentLoaded', function () {
  dataAttributeHandler.setBaseElement(_globals.default.document.body);
  dataAttributeHandler.handle();
});

var _default = dataAttributeHandler;
exports.default = _default;
...
var _dataAttributes = _interopRequireDefault(__webpack_require__(37));
...
function (_Disposable) {
  ...
  _createClass(AppDataAttributeHandler, [{
    ...
    value: function handle() {
      ...
      if (!this.baseElement.hasAttribute(_dataAttributes.default.senna)) {
    ...
    value: function maybeAddRoutes_() {
      ...
      if (!this.app.hasRoutes()) {
        this.app.addRoutes(new _Route.default(/.*/, _HtmlScreen.default));
    ...
    value: function maybeAddSurfaces_() {
      ...
      var surfacesSelector = '[' + _dataAttributes.default.surface + ']';
    ...
    value: function maybeDispatch_() {
      if (this.baseElement.hasAttribute(_dataAttributes.default.dispatch)) {
        this.app.dispatch();
      }
    }
    /**
    ...
    value: function maybeParseLinkRoute_(link) {
      var route = new _Route.default(this.maybeParseLinkRoutePath_(link), this.maybeParseLinkRouteHandler_(link));
    ...
    value: function maybeSetBasePath_() {
      var basePath = this.baseElement.getAttribute(_dataAttributes.default.basePath);
    ...
    value: function maybeSetLinkSelector_() {
      var linkSelector = this.baseElement.getAttribute(_dataAttributes.default.linkSelector);
    ...
    value: function maybeSetLoadingCssClass_() {
      var loadingCssClass = this.baseElement.getAttribute(_dataAttributes.default.loadingCssClass);
    ...
    value: function maybeSetUpdateScrollPosition_() {
      var updateScrollPosition = this.baseElement.getAttribute(_dataAttributes.default.updateScrollPosition);
    ...
    value: function updateElementIdIfSpecialSurface_(element) {
      if (!element.id && element === _globals.default.document.body) {
...
var _default = AppDataAttributeHandler;
exports.default = _default;
